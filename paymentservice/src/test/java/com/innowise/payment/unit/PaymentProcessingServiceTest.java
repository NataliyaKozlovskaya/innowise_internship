...
//    when(paymentService.updatePayment(any(), any())).thenReturn(any());
//
...
//    verify(kafkaTemplate).send(any(), any(), any(PaymentProcessedEvent.class));
...
//    verify(paymentService).createPayment(any(Payment.class));// todo
//    verify(externalPaymentService).generatePaymentId();
