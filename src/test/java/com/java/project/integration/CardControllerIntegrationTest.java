...
import static com.java.util.TestDataFactory.getCreateCardRequest;
...
class CardControllerIntegrationTest extends AbstractIntegrationTest {
  ...
  void createCard_WithValidData_ShouldReturnCreatedCard() {
    CreateCardRequest request = getCreateCardRequest("1234567890123456", "Petr Ivanov",
  ...
  void createCard_WithInvalidUserId_ShouldReturnBadRequest() {
    CreateCardRequest request = getCreateCardRequest("1234560090123456", "Anna Ivanova",
  ...
  void createCard_WithInvalidCardNumber_ShouldReturnBadRequest() {
    CreateCardRequest request = getCreateCardRequest(null, "Anna Ivanova",
        LocalDate.now().plusYears(2));
