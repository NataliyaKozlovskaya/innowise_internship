...
public class MyLinkedListImpl<T> implements MyLinkedList<T> {
  ...
  /**
   * Method determine which side is closer to start
   *
   * @param size  size of a LinkedList
   * @param index index of an element
   * @return boolean
   */
  private boolean isCloserToStart(int size, int index) {
    return index < size / 2;
  }
}