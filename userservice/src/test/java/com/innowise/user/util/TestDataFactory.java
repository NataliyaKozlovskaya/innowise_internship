...
public final class TestDataFactory {
  ...
  public static UserCreateResponse getUserDTO(String uuid, String name, String surname, LocalDate date, String email) {
    return new UserCreateResponse(uuid, surname, name, date, email);
  }
