package com.java.project.authenticationservice.controller;
...
import com.java.project.authenticationservice.service.impl.UserCredentialsServiceImpl;
...
public class AuthenticationController {
  ...
  public ResponseEntity<Void> register(@Valid @RequestBody LoginRequest request) {
    userCredentialsService.createUserCredentials(request.login(), request.password());
